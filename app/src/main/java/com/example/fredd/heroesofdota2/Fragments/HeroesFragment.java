package com.example.fredd.heroesofdota2.Fragments;
...
import com.example.fredd.heroesofdota2.Services.HeroService;
import com.example.fredd.heroesofdota2.Services.IHeroService;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                heroArrayList = heroService.getHeroes();
                recyclerHeroes.setLayoutManager(new LinearLayoutManager(getContext()));

                HeroesRecyclerAdapter heroesRecyclerAdapter =
                        new HeroesRecyclerAdapter(heroArrayList);
